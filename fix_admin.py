...
def fix_admin_handlers():
    """Fix admin handlers file"""
    
    admin_handlers_content = '''"""
Handler های ادمین ربات تلگرام
"""
import re
import requests
...
انتخاب کنید:"""
            ...
            await update.message.reply_text(f"❌ خطا در بارگذاری پنل مدیریت: {str(e)}")
